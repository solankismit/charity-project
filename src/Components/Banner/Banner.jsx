        ...
        <div className="bg-primary-light banner " >
            <div className="flex items-center h-screen md:h-max p-4 w-full px-3 mx-auto  max-w-lg xl:max-w-xl xxl:max-w-xxl">
                ...
                <div className="relative flex-1 mt-20 md:my-40">
                    <h1 className="text-5xl md:text-8xl mb-7 w-4/5 md:w-3/4 lg:w-1/2 font-bold text-dark-grey font-oto">Help for Hopeless</h1>
                    <h2 className="text-base md:text-lg text-medium-grey w-4/5 lg:w-1/3 mb-7">Fight for right cause for save the world. Every child deserves a better future!</h2>
